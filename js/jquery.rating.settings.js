...
$crfp(document).ready(function() {
    $crfp('form#commentform p').each(function(i,item) {
        if ($crfp('textarea[name=comment]', $crfp(item)).length > 0) {
            $crfp(item).after('<p><label for="rating-star">Rating</label><input name="rating-star" type="radio" class="star" value="1" /><input name="rating-star" type="radio" class="star" value="2" /><input name="rating-star" type="radio" class="star" value="3" /><input name="rating-star" type="radio" class="star" value="4" /><input name="rating-star" type="radio" class="star" value="5" /><input type="hidden" name="crfp-rating" value="0" /></p>'); // Add rating field to end of comment form    
        }
    });
